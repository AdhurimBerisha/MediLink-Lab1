...
const DoctorDashboard = () => {
  ...
  console.log("latestAppointments", dashData?.latestAppointments);
                  ...
                  {currentPage > 1 && (
                    <li>
                      <button
                        ...
                        className="px-3 py-1 cursor-pointer rounded-md border border-gray-300 bg-white text-gray-500 hover:bg-gray-50"
                      >
                        Previous
                      </button>
                    </li>
