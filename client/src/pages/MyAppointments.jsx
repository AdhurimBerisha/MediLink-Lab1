                  ...
                  <>
                    {item.payment ? (
                      ...
                      <Link to={`/payment/${item._id}`}>
                        <button className="text-sm cursor-pointer text-stone-500 text-center sm:min-w-48 py-2 border hover:bg-[#36a3ca] hover:text-white transition-all duration-300">
                          Pay Online
                        </button>
                      </Link>
                    )}
                    ...
                    <button
                      ...
                      className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border cursor-pointer hover:bg-red-600 hover:text-white transition-all duration-300"
                    >
                      Cancel Appointment
                    </button>
                  </>
